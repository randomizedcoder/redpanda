{
  ...
  "registryFileHashes": {
    ...
    "https://bcr.bazel.build/modules/snappy/1.2.2.bcr.3/MODULE.bazel": "a89f02d52e9cd6aff44ca62d1052aef2b044c0dc3fb5da659f0f299596764d5e",
    "https://bcr.bazel.build/modules/snappy/1.2.2.bcr.3/source.json": "6cefb1f9c60dfff3492d335d4aa4fd6aa69316c3d3f6d3dfa99c15a2fa6e9212",
    ...
    "https://bcr.bazel.build/modules/utf8proc/2.11.0/MODULE.bazel": "e3f80ea9347a38598f0f099ece8db7ef8a2582f16bcfa2ded6bed51d49f967d2",
    "https://bcr.bazel.build/modules/utf8proc/2.11.0/source.json": "4ff6d6a7b031111d20a5b712b3d78d9de74904cd75cd5b5556ef453df4496b1c",
  ...
  "moduleExtensions": {
    "//bazel:extensions.bzl%non_module_dependencies": {
      "general": {
        "bzlTransitiveDigest": "0MfYtEJZYCbtE9IJ8M8dklF/mg4MvvDHcwh4QYvhsDM=",
        ...
        "generatedRepoSpecs": {
          "ada": {
            ...
            "attributes": {
              "path": "nix_ada",
              "build_file": "@@//bazel/thirdparty:ada-prebuilt.BUILD"
            }
          },
          "avro": {
          ...
          "base64": {
            ...
            "attributes": {
              "path": "nix_base64",
              "build_file": "@@//bazel/thirdparty:base64-prebuilt.BUILD"
            }
          },
          "c-ares": {
            "repoRuleId": "@@bazel_tools//tools/build_defs/repo:local.bzl%new_local_repository",
          ...
          "hdrhistogram": {
            "repoRuleId": "@@bazel_tools//tools/build_defs/repo:local.bzl%new_local_repository",
            "attributes": {
              "path": "nix_hdrhistogram",
              "build_file": "@@//bazel/thirdparty:hdrhistogram-prebuilt.BUILD"
            }
          },
          "hwloc": {
            "repoRuleId": "@@bazel_tools//tools/build_defs/repo:local.bzl%new_local_repository",
          ...
          "lksctp": {
            ...
            "attributes": {
              "path": "nix_lksctp",
              "build_file": "@@//bazel/thirdparty:lksctp-prebuilt.BUILD"
            }
          },
          "openssl": {
            "repoRuleId": "@@bazel_tools//tools/build_defs/repo:local.bzl%new_local_repository",
          ...
          "openssl-fips": {
            "repoRuleId": "@@bazel_tools//tools/build_defs/repo:local.bzl%new_local_repository",
            "attributes": {
              "path": "nix_openssl_fips",
              "build_file": "@@//bazel/thirdparty:openssl-fips-prebuilt.BUILD"
            }
          },
          "rapidjson": {
            "repoRuleId": "@@bazel_tools//tools/build_defs/repo:http.bzl%http_archive",
          ...
          "roaring": {
            ...
            "attributes": {
              "path": "nix_roaring",
              "build_file": "@@//bazel/thirdparty:roaring-prebuilt.BUILD"
            }
          },
          "seastar": {
            "repoRuleId": "@@bazel_tools//tools/build_defs/repo:http.bzl%http_archive",
          ...
          "xxhash": {
            ...
            "attributes": {
              "path": "nix_xxhash",
              "build_file": "@@//bazel/thirdparty:xxhash-prebuilt.BUILD"
            }
          },
          "crates": {
            "repoRuleId": "@@bazel_tools//tools/build_defs/repo:local.bzl%new_local_repository",
    ...
    "//bazel:python_deps.bzl%python_deps_ext": {
      "general": {
        "bzlTransitiveDigest": "g8lPjU4LJcVvUIwTMkrzSSkTzuDrLv9EZEXQK21LgcE=",
    ...
    "@@rules_buf+//buf:extensions.bzl%buf": {
      "general": {
        "bzlTransitiveDigest": "EQJvDePPypiKXoo5wVTmSTK6nVNh6YcG+M1w0FowPQo=",
